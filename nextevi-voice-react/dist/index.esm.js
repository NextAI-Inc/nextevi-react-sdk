...
export { CONNECTION_STATES, DEFAULT_CONFIG, NEXTEVI_VERSION, VoiceProvider, configFromEnvironment, createConnectionConfig, devUtils, generateConnectionId, getBrowserInfo, getDefaultWebSocketUrl, isAudioSupported, isDevelopment, isEnvironmentSupported, maskApiKey, quickStart, requestMicrophonePermission, useSimpleVoice, useVoice, useVoiceAudio, useVoiceDebug, useVoiceMessages, useVoiceStatus, validateApiKey, validateConfig, validateConfigId, validateProjectId };
